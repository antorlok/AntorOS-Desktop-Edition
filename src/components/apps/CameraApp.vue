<template>
  <div class="app-placeholder camera-app">
    ...
    <div class="app-header">
      ...
      <div>
        <h2 class="app-title">Capturadora Óptica Cyber-CRT</h2>
        <span class="app-subtitle">Cámara y grabadora de video virtual</span>
      </div>
    </div>

    <!-- Visor de cámara real con filtros cyberpunk y CRT -->
    <div class="camera-body">
      <div class="camera-viewfinder" :class="{ 'flash-active': showFlash }">
        ...
        <div v-if="!streamActive" class="camera-loading-state">
          <span class="glitch-text">INICIALIZANDO DISPOSITIVO ÓPTICO...</span>
...
.crt-glow {
  position: absolute;
  inset: 0;
  background: radial-gradient(circle, transparent 60%, rgba(217, 70, 239, 0.12) 100%);
  pointer-events: none;
  z-index: 4;
}
