  ...
  <div class="store-app-container">
    ...
    <aside class="store-sidebar">
      <div class="store-brand">
        ...
        <span class="brand-title">Cyber Store</span>
      </div>
    ...
    <main class="store-main-content">
      ...
      <div v-if="activeTab === 'explore'" class="tab-content explore-tab">
        <div class="header-section">
          ...
          <p class="section-sub">Potencia tu entorno AntorOS con las mejores herramientas cibernéticas de la red.</p>
        </div>
        ...
        <div class="apps-grid">
          ...
          <div v-if="storeStore.availableApps.length === 0" class="store-empty-state">
            ...
            <p class="empty-desc">Todas las aplicaciones del catálogo de Cyber Store ya están instaladas en tu sistema.</p>
          </div>
        </div>
      </div>
      ...
      <div v-else-if="activeTab === 'manage'" class="tab-content manage-tab">
        <div class="header-section">
          ...
          <p class="section-sub">Administra y desinstala tus paquetes virtuales de terceros en AntorOS.</p>
        </div>
        ...
        <div class="installed-list">
          ...
          >
            ...
            <!-- Botón Desinstalar Cyberpunk Rojo -->
            <button
              type="button"
              class="uninstall-btn"
