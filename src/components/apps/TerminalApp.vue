...
const prompt = '\x1b[36m[antorlok@antor-os ~]$\x1b[0m ';
...
function processCommand(cmd: string): void {
  ...
  if (mainCommand === 'fastfetch') {
    ...
    const output = [
      '\r\n',
      '\x1b[1;36m    /\\_/\\      \x1b[1;37mOS:\x1b[0m Antor OS x86_64',
      '\x1b[1;36m   ( o.o )     \x1b[1;37mHost:\x1b[0m Lenovo Legion 5 15ARP8',
      '\x1b[1;36m    > ^ <      \x1b[1;37mKernel:\x1b[0m Antor-Go-Daemon v1.0',
      `               \x1b[1;37mUptime:\x1b[0m ${uptime}`,
      `               \x1b[1;37mPackages:\x1b[0m ${installedCount} antpac`,
  ...
  if (mainCommand === 'antpac') {
    ...
    if (action === 'list') {
      term?.write('\r\nAplicaciones disponibles para instalación en Cyber Store:\r\n');
