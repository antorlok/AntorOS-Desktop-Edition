<template>
  <div class="bench-container">
    <div class="bench-card">
      ...
      <p class="bench-desc">Mide el rendimiento máximo simulado de tu núcleo AntorOS.</p>
...
function runBenchmark() {
  ...
  addLog('Iniciando batería de pruebas AntorOS Benchmarks...', 'info');
  ...
  testTimer = setInterval(() => {
    ...
    if (step === 1) {
      ...
      addLog(`Puntuación final: ${score.toLocaleString()} ANTOR-POINTS`, 'success-glow');
    }
  }, 1000);
}
