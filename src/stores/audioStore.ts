...
export const useAudioStore = defineStore('audio', () => {
  ...
  const savedMute = localStorage.getItem('antorui-audio-muted');
  ...
  watch(volume, (newVol) => {
    localStorage.setItem('antorui-audio-volume', String(newVol));
  });

  watch(isMuted, (newMute) => {
    localStorage.setItem('antorui-audio-muted', String(newMute));
  });
